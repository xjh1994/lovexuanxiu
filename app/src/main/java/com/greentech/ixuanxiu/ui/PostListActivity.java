 ...
 */
public class PostListActivity extends BaseActivity implements MyItemClickListener, MyItemLongClickListener {
    /**
     * 讨论列表
     */
    ...
    PostAdapter postAdapter = new PostAdapter(PostListActivity.this, posts);
    ...
    public void initViews() {
        ...
        linearLayoutManager = new LinearLayoutManager(PostListActivity.this);
        ...
        postAdapter.setCustomLoadMoreView(LayoutInflater.from(this)
    ...
    private void queryData(final int page, final int actionType) {
        ...
        query.findObjects(PostListActivity.this, new FindListener<Post>() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.send:
                ...
                Intent intent = new Intent(PostListActivity.this, PostAddActivity.class);
                intent.putExtras(data);
                startActivity(intent);
                break;
            default:
